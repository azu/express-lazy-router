...
The behavior when you use loader like [@babel/register](https://babeljs.io/docs/en/babel-register).
...
Behavior when you use loader like [@babel/register](https://babeljs.io/docs/en/babel-register).
